        ...
        <div class="card mt-2">
            <div class="card-body">
                <div class="atas" style="vertical-align: middle;">
                    ...
                    <h4 class="text-right" style="font-weight: bold;">Faktur Pembelian</h4>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-3" style="font-size: 14px;">
                        : {{ $purchase->invoice_number }} <br>
                        : {{ $purchase->order_date }} <br>
                ...
                <table class="table table-sm table-bordered mt-4 text-center">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td>Rp. {{ number_format($purchase->detail_purchase->sum('total_price'), 0, ',', '.') }}
                            </td>
                        </tr>
                    </tfoot>
                </table>
