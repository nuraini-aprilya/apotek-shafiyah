            ...
            <table class="table table-sm table-striped table-bordered text-center">
                ...
                <tbody>
                    @foreach ($receipt->detail_receipt as $detail)
                        <tr>
                            <td><input type="text" class="form-control" value="{{ $detail->product->name }}" readonly>
                            </td>
                            <td><input type="text" class="form-control" value="{{ $detail->product->batch_number }}"
                                    readonly>
                            </td>
                            <td><input type="text" class="form-control" value="{{ $detail->product->unit->name }}"
                                    readonly>
                            </td>
