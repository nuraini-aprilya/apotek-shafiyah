        ...
        <div class="card mt-2">
            <div class="card-body">
                <div class="atas" style="vertical-align: middle;">
                    ...
                    <h4 class="text-right" style="font-weight: bold;">Faktur Pengembalian</h4>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-3" style="font-size: 14px;">
                        : {{ $refund->purchase->invoice_number }} <br>
                        : {{ $refund->purchase->order_date }} <br>
                        : {{ $refund->purchase->supplier->name }} <br>
                        : {{ $refund->purchase->supplier->phone_number }} <br>
                    </div>
                </div>
