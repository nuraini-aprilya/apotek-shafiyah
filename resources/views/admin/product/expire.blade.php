...
@section('title', 'Produk Kadaluarsa')
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Produk Kadaluarsa</li>
            </ol>
        </div>
    </div>
@endsection
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header bg-light">
                    <h3 class="card-title">Produk Kadaluarsa</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                ajax: '{{ route('admin.expire.product') }}',
                columns: [{
                        data: 'DT_RowIndex'
                    },
                    {
